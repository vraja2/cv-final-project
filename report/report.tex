...
\begin{figure*}[htp]
  \centering
  \subfigure[random caption 1]{\includegraphics[height=1.3in,width=1.6in]{./images/2804_left.jpeg}
}\quad
  \subfigure[random caption 2]{\includegraphics[height=1.3in,width=1.6in]{./images/dh_2804left.png}}
\end{figure*}
