...
\begin{figure*}[htp]
\centering
\subfigure{\includegraphics[height=1.3in,width=1.6in]{./images/Exudates_Description/0.jpeg}
}
  \subfigure{\includegraphics[height=1.3in,width=1.6in]{./images/Exudates_Description/1.jpeg}
}
  \subfigure{\includegraphics[height=1.3in,width=1.6in]{./images/Exudates_Description/2.jpeg}
}
  \subfigure{\includegraphics[height=1.3in,width=1.6in]{./images/Exudates_Description/3.jpeg}
}
  \subfigure{\includegraphics[height=1.3in,width=1.6in]{./images/Exudates_Description/4.jpeg}
}
  \subfigure{\includegraphics[height=1.3in,width=1.6in]{./images/Exudates_Description/5.jpeg}
}
\end{figure*} 
